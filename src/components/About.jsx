...
<Helmet>
  <title>About Us | Digital Express India</title>
  <meta
    name="description"
    content="Learn more about Digital Express India, a trusted website development and digital services company helping businesses grow online."
  />
  <meta
    name="keywords"
    content="about digital express india, web development company india, digital agency"
  />
  <link rel="canonical" href="https://digitalexpressindia.com/about" />
</Helmet>
    ...
    <section  className="flex flex-col md:flex-row items-center justify-center gap-10 lg:gap-30 max-md:px-4 mt-15 lg:mt-20 mont" id="about">
                ...
                <div className="text-sm text-slate-600 max-w-xl ">
                    ...
                    <p ref={textRef} className="mt-5 font-semibold exo alan text-xl lg:text-2xl  ">Digital Express India is a digital agency crafting innovative designs, powerful brands, 
                  and user-focused experiences. We turn ideas into impactful solutions throughcreativity, strategy, and technology — helping businesses grow and audiences connect.</p>
                    <button      onClick={goToContact} className=" magnet flex items-center gap-2 mt-8  transition bg-white text-black  py-3 px-8 rounded-3xl  border-2 border-black text-lg"   >
